...
export const productDto = Joi.object({
    ...
    categoryName: Joi.string().required(),
    productType: Joi.string().valid(Constant.PRODUCT_TYPE.DOG, Constant.PRODUCT_TYPE.CAT).required(),
...
export const updateProductDto = Joi.object({
    ...
    categoryName: Joi.string().allow(null),
    productType: Joi.string().valid(Constant.PRODUCT_TYPE.DOG, Constant.PRODUCT_TYPE.CAT).allow(null),
