...
export const productDto = Joi.object({
    ...
    categoryName: Joi.string().required(),
    productType: Joi.string().valid(Constant.TYPE_PRODUCT.DOG, Constant.TYPE_PRODUCT.CAT).required(),
...
export const updateProductDto = Joi.object({
    ...
    categoryName: Joi.string().allow(null),
    productType: Joi.string().valid(Constant.TYPE_PRODUCT.DOG, Constant.TYPE_PRODUCT.CAT).allow(null),
