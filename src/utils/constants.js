...
export const RESPONSE_MESSAGE = {
    ...
    INVALID_USERNAME: "Tên tài khoản không hợp lệ. Vui lòng chọn lại tên tài khoản!",
    INVALID_IMAGE: "Hình ảnh không hợp lệ. Vui lòng chọn lại hình ảnh!",
    INVALID_INVENTORY: "Số lượng tồn không hợp lệ. Vui lòng chọn lại số lượng tồn!",
    INVALID_CATEGORY: "Danh mục không hợp lệ. Vui lòng chọn lại danh mục!",
    INVALID_CATEGORY_TYPE: "Loại danh mục không hợp lệ. Vui lòng chọn lại loại danh mục!",
